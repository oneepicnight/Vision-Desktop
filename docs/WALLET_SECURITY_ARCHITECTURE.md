...
The verified identity, amount, nonce/fee, serialization, transaction-identifier, signature, and submission-response contracts do not unlock user-facing transaction signing. Wallet creation and restore remain disabled until receipt/finality and private-loopback compatibility are complete and the recovery UX and independent security review pass.
