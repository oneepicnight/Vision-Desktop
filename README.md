...
The planned wallet Tauri boundary is documented in `docs/WALLET_TAURI_COMMAND_THREAT_MODEL.md`. It is a specification only: no wallet command, native dialog dependency, capability, password form, or frontend service has been activated. Local vault passwords now require at least 16 bytes, matching the portable-recovery minimum.
