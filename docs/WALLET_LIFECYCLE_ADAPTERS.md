...
deleted. Restore accepts only the exact versioned, checksummed credential format generated by Rust;
legacy arbitrary recovery passwords are rejected before the KDF. Restore completes locked.
